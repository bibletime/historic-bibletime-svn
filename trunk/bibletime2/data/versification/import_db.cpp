...
int main(int argc, char *argv[])
{
	...
	try{	
		...
		QStringList data= readFile("ccel/Bible.xml");
		feedSchema(schema_db, "bible", data);
	
		data = readFile("ccel/Bible.NAB.xml");
		feedSchema(schema_db, "bible_nab", data);
	
		data = readFile("ccel/Bible.NJB.xml");
		feedSchema(schema_db, "bible_njb", data);
	
		data = readFile("ccel/Bible.ORG.xml");
		feedSchema(schema_db, "bible_org", data);
	
		data = readFile("ccel/Bible.Vul.xml");
		feedSchema(schema_db, "bible_vul", data);
	
		data = readFile("ccel/Bible.LXX.xml");
		feedSchema(schema_db, "bible_lxx", data);
	
		data = readFile("ccel/refsysmap.unl");
