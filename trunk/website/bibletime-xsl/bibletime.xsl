...
Page
        ...
        <div id="header">
          <a href="http://www.bibletime.info/">
            <img src="/images/header-logo.png" id="headerlogo"
            alt="headerlogo" />
          </a>
          <div id="flags">
...
en cs da de es fi fr nl nn pt-br ko ru
        ...
        <div id="rightpanel">
          ...
          <div id="logos">
            <a href="http://sourceforge.net/projects/bibletime">
              <img src="http://sflogo.sourceforge.net/sflogo.php?group_id=954&amp;type=13"
              width="120" height="30" border="0"
              alt="Get BibleTime at sourceforge.net." />
            </a>
            <br />
        ...
        _gat._getTracker("UA-1186927-1"); pageTracker._initData();
